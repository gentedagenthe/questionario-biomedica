...
export default function Questionario() {
  ...
  function validarEtapa() {
    ...
    if (step === 3) return form.pj && form.disponibTempo;
    return true;
  }
      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '32px 20px 80px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 14, boxShadow: '0 2px 16px rgba(0,0,0,.07)', padding: 32 }}>
          ...
          {step === 3 && <>
            ...
            <TextArea label="Qual sua disponibilidade de tempo para a realização dos serviços? A agenda da clínica é de segunda a sábado, no período da manhã." name="disponibTempo" value={form.disponibTempo} onChange={hf} placeholder="Descreva os dias e horários em que pode atender..." />
