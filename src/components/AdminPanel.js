    ...
    <div style={{ background: '#fff', borderRadius: 14, boxShadow: '0 2px 14px rgba(0,0,0,.07)', marginBottom: 18, overflow: 'hidden', border: '1px solid #E8E8E8' }}>
      ...
      {aberto && (
        <div style={{ padding: '22px 24px' }}>
          ...
          {c.disponibTempo && <p style={{ fontSize: 13, background: '#F5F5F5', borderRadius: 7, padding: '8px 10px', marginTop: 6 }}><strong>Disponibilidade de tempo (seg a sáb, manhã):</strong> {c.disponibTempo}</p>}
