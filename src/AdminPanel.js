    ...
    <div style={{ background: '#fff', borderRadius: 14, boxShadow: '0 2px 14px rgba(0,0,0,.07)', marginBottom: 18, overflow: 'hidden', border: '1px solid #E8E8E8' }}>
      <div style={{ background: '#1A3C5E', padding: '18px 24px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <div style={{ color: 'rgba(255,255,255,.65)', fontSize: '.78rem', marginTop: 2 }}>{c.email || '—'} • {c.telefone || '—'} • CPF: {c.cpf || '—'}</div>
        </div>
      ...
      {aberto && (
        <div style={{ padding: '22px 24px' }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#1A3C5E', textTransform: 'uppercase', marginBottom: 10, borderBottom: '2px solid #EAF3FB', paddingBottom: 6 }}>Identificação</div>
          <p style={{ fontSize: 13, marginBottom: 4 }}>CPF: <strong>{c.cpf || '—'}</strong></p>
          <p style={{ fontSize: 13, marginBottom: 4 }}>Data de nascimento: {c.nascimento || '—'}</p>

          <div style={{ fontSize: 13, fontWeight: 700, color: '#1A3C5E', textTransform: 'uppercase', margin: '18px 0 10px', borderBottom: '2px solid #EAF3FB', paddingBottom: 6 }}>Formação</div>
